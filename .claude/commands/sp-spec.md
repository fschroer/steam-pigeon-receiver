---
description: Restate a code-change request and name its ambiguities before writing any code
---

**The definition of this command lives in the Locator repo, not here.** Read and follow:

```
C:\STM32_Projects\Locator\.claude\commands\sp-spec.md
```
...
It applies to work in this repo; only its text is centralized.
